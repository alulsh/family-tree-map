...
},{"process":"node_modules/process/browser.js"}],"node_modules/tree-crawl/dist/tree-crawl.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{"tree-crawl":"node_modules/tree-crawl/dist/tree-crawl.js","./d3ize":"node_modules/parse-gedcom/d3ize.js"}],"node_modules/datatables.net/js/jquery.dataTables.js":[function(require,module,exports) {
var define;
/*! DataTables 1.10.23
...
},{"./bundle-url":"node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/datatables.net-dt/css/jquery.datatables.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"./../images/sort_both.png":[["sort_both.e31b43a7.png","node_modules/datatables.net-dt/images/sort_both.png"],"node_modules/datatables.net-dt/images/sort_both.png"],"./../images/sort_asc.png":[["sort_asc.431e7c00.png","node_modules/datatables.net-dt/images/sort_asc.png"],"node_modules/datatables.net-dt/images/sort_asc.png"],"./../images/sort_desc.png":[["sort_desc.538004ae.png","node_modules/datatables.net-dt/images/sort_desc.png"],"node_modules/datatables.net-dt/images/sort_desc.png"],"./../images/sort_asc_disabled.png":[["sort_asc_disabled.61d0fccd.png","node_modules/datatables.net-dt/images/sort_asc_disabled.png"],"node_modules/datatables.net-dt/images/sort_asc_disabled.png"],"./../images/sort_desc_disabled.png":[["sort_desc_disabled.7b0aacd2.png","node_modules/datatables.net-dt/images/sort_desc_disabled.png"],"node_modules/datatables.net-dt/images/sort_desc_disabled.png"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/dayjs/esm/constant.js":[function(require,module,exports) {
"use strict";
...
},{}],"family-tree.js":[function(require,module,exports) {
"use strict";
...
},{"dayjs":"node_modules/dayjs/esm/index.js","dayjs/plugin/localizedFormat":"node_modules/dayjs/plugin/localizedFormat.js","dayjs/plugin/customParseFormat":"node_modules/dayjs/plugin/customParseFormat.js"}],"geocode.js":[function(require,module,exports) {
"use strict";
...
exports.geocodePerson = geocodePerson;
exports.updateTableAndMarker = updateTableAndMarker;
...
var _familyTree = require("./family-tree");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _datatables.default)();
var dataTable = (0, _jquery.default)('#ancestor-table').DataTable();
mapboxgl.accessToken = 'pk.eyJ1IjoiYWx1bHNoIiwiYSI6ImNra2JmZHplYzBjcXgyd291M3l2aWIxODAifQ.uCZpVDpR-z3BEUV0R7S1NA';
...
function updateMarkers() {
  var markers = (0, _jquery.default)('.mapboxgl-marker');

  if (markers.length !== 0) {
    (0, _jquery.default)(markers).each(function toggleMarkerVisibility(index, marker) {
      var markerRelevance = (0, _jquery.default)(marker).data('relevance');
      var foundMarker = marker;

      if (markerRelevance < (0, _jquery.default)('#relevanceRange').val()) {
...
function geocodePerson(person) {
  return new Promise(function (resolve, reject) {
    var geocodeURL = "https://api.mapbox.com/geocoding/v5/mapbox.places/".concat(person.birthPlace, ".json?limit=1&access_token=").concat(mapboxgl.accessToken);
...
function createMarker(person, visibility) {
  var marker = new mapboxgl.Marker().setLngLat(person.longLat).setPopup(new mapboxgl.Popup({
    offset: 25
  }).setHTML("<p>Name: ".concat(person.name.firstName, " ").concat(person.name.lastName, "</br>\n      Birth place: ").concat(person.birthPlace, "</br>\n      Birth date: ").concat(person.birthDate, "</br>\n      Geocoding result: ").concat(person.geocodedPlace, "</br>\n      Relevance: ").concat(person.relevance, "</p>"))).addTo(map);
  var markerHTML = marker.getElement();
...
function updateTableAndMarker(person, geocodingResults) {
  ...
  dataTable.row.add([geocodedPerson.name.firstName, geocodedPerson.name.lastName, geocodedPerson.birthDate, geocodedPerson.birthPlace, geocodedPerson.relevance, geocodedPerson.geocodedPlace]);
  dataTable.draw();

  if (geocodedPerson.relevance < (0, _jquery.default)('#relevanceRange').val()) {
...
function getIndividual(individual) {
  if (individual.tag === 'INDI') {
    var person = {
      name: (0, _familyTree.getName)(individual),
      birthPlace: (0, _familyTree.getBirthInfo)(individual).birthPlace,
      birthDate: (0, _familyTree.processDate)((0, _familyTree.getBirthInfo)(individual).birthDate)
    };

    if (person.birthPlace === null) {
      dataTable.row.add([person.name.firstName, person.name.lastName, person.birthDate, 'Missing birth place', '', '']);
      dataTable.draw();
    } else {
      geocodePerson(person).then(function (geocodingResults) {
...
},{"jquery":"node_modules/jquery/dist/jquery.js","datatables.net":"node_modules/datatables.net/js/jquery.dataTables.js","datatables.net-dt/css/jquery.datatables.css":"node_modules/datatables.net-dt/css/jquery.datatables.css","./family-tree":"family-tree.js"}],"window-functions.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateRelevance = updateRelevance;
exports.readGedcomFile = readGedcomFile;
...
function updateRelevance(value) {
  (0, _jquery.default)('#relevanceOutput').val(value);
  (0, _geocode.updateMarkers)();
}

function readGedcomFile(file) {
  return new Promise(function (resolve, reject) {
    var gedcomFile = file.target.files[0];
    var reader = new FileReader();
    reader.readAsText(gedcomFile);

    reader.onload = function loadGedcom(event) {
      (0, _jquery.default)('#results').css('visibility', 'visible');

      var gedcomJSON = _parseGedcom.default.parse(event.target.result);

      if (_jquery.default.isEmptyObject(gedcomJSON)) {
      ...
      gedcomJSON.forEach(function (individual) {
        (0, _geocode.getIndividual)(individual);
      });
      resolve(gedcomJSON);
    };
...
function showTooltip(event) {
  var tooltip = (0, _jquery.default)('#tooltip');
  tooltip.css({
    display: 'block',
    left: "".concat(event.pageX + 10, "px"),
    top: "".concat(event.pageY + 10, "px")
  });
}
...
},{"jquery":"node_modules/jquery/dist/jquery.js","parse-gedcom":"node_modules/parse-gedcom/index.js","./geocode":"geocode.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","window-functions.js"], null)
//# sourceMappingURL=/window-functions.86307cf9.js.map